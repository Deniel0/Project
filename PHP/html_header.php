...
<body>
  <!-- <nav class="navbar navbar-dark bg-dark"> -->
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <a href="Components.php"><button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="false">Components</button></a>
      </li>
      <li class="nav-item" role="presentation">
        <a href="Info.php"><button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="false">Info</button></a>
      </li>
        <li class="nav-item" role="presentation">
          <a href="login.php"><button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="false">Login</button></a>
        </li>
        <li class="nav-item" role="presentation">
