...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2022 at 01:46 PM
...
INSERT INTO `ram` (`ram_id`, `Manufacturer_id`, `ram_type_id`, `Capacity`, `Speed`, `Modules`, `CAS Latency`) VALUES
...
INSERT INTO `users` (`user_id`, `username`, `title`, `user_pwd`) VALUES
(1, 'Deniel', 1, 'alma'),
(2, 'Béla', 0, 'none');
